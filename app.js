...
//Question 2:
console.log("---------")
const newObjectList = () => ({key1: 'value1', key2: 'value2', key3: 'value3'});
...
// joe's object in constructor student
// 2. What is "this" when joe.scopeArrow() is invoked?
// nothing in constructor or object it's for window object
// 3. Explain why "this" is different when an arrow function is used.
// when we use (this) for constructor to arrow function it will be global